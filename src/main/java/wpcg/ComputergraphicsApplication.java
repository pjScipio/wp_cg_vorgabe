...
public class ComputergraphicsApplication extends SimpleApplication {
  ...
  private void setupInput() {
    ...
    inputManager.addMapping(MOUSE_MOVED_LEFT,
            new MouseAxisTrigger(MouseInput.AXIS_X, false));
    inputManager.addMapping(MOUSE_MOVED_RIGHT,
            new MouseAxisTrigger(MouseInput.AXIS_X, true));
    inputManager.addMapping(MOUSE_MOVED_UP,
            new MouseAxisTrigger(MouseInput.AXIS_Y, false));
    inputManager.addMapping(MOUSE_MOVED_DOWN,
            new MouseAxisTrigger(MouseInput.AXIS_Y, true));
    inputManager.addMapping(MOUSE_WHEEL_UP,
            new MouseAxisTrigger(MouseInput.AXIS_WHEEL, true));
    inputManager.addMapping(MOUSE_WHEEL_DOWN,
    ...
    inputManager.addListener(analogListener, MOUSE_MOVED_RIGHT, MOUSE_MOVED_UP,
            MOUSE_MOVED_DOWN);
  ...
  private final ActionListener actionListener = new ActionListener() {
    public void onAction(String name, boolean keyPressed, float tpf) {
      switch (name) {
        case TRIGGER_MOUSE_LEFT_CLICK:
          mouseLeftPressed = !mouseLeftPressed;
          break;
        case TRIGGER_MOUSE_RIGHT_CLICK:
          mouseRightPressed = !mouseRightPressed;
          break;
        case TRIGGER_MOUSE_MIDDLE_CLICK:
  ...
  private static final String TRIGGER_MOUSE_LEFT_CLICK
          = "MOUSE_LEFT_CLICK_DOWN_RELEASE";
  private static final String TRIGGER_MOUSE_RIGHT_CLICK
          = "MOUSE_RIGHT_CLICK_DOWN_RELEASE";
  private static final String TRIGGER_MOUSE_MIDDLE_CLICK
          = "MOUSE_MIDDLE_CLICK_DOWN_RELEASE";
